...
class ResizeImg
{
    ...
    public function compression($width,$height){
        $prHeight = $height/($width/$this->getWidth());
        $prWidth = $width/($height/$this->getHeight());

        if($this->getWidth()>$this->getHeight()){
            $x1 = ($this->getWidth()-$prWidth)/2;
            $y1 = ($this->getHeight()-$prHeight)/2;
        ...
        $obj = $this->crop($x1, $y1, $x2, $y2)->resample($width,$height);
        return $obj;
    }
}